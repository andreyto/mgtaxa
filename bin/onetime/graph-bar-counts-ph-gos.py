...
def prepData(self,db,rank):
    ...
    db.createTableAs("%s_abund_ref_met" % (tbl_pref,),"""\
            SELECT a.name,a.cnt as cnt_ref,b.cnt as cnt_met
    ...
    db.createTableAs("%s_abund_met_ref" % (tbl_pref,),"""\
            SELECT b.name,a.cnt as cnt_ref,b.cnt as cnt_met
    ...
    db.createTableAs("%s_abund_full_join" % (tbl_pref,),"""\
            SELECT DISTINCT *
            FROM   %(tbl_pref)s_abund_full_join_1""" % dict(tbl_pref=tbl_pref))
    return
